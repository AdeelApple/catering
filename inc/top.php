...
<body id="page-top" onload="ready()">
  <!-- WRAPPER START -->
  <div id="wrapper" class="wrapper <?php if(!$sb) echo 'pl-0'; ?>">
  	<nav class="navbar navbar-expand bg-primary static-top">
      <button class="btn btn-primary text-white order-1 order-sm-0 mr-3" onclick="sidebar_tgl_session()" id="sidebarToggle">
      ...
      <div class="w-100 d-flex d-sm-none"></div>
        ...
        <div class="col p-2">
          <h6 class="text-light text-nowrap mb-0 small text-right">Welcome: <span class="text-uppercase font-weight-bold"><?=$fname?></span><br>Logged as: <span class="text-uppercase font-weight-bold"><?=$type?></span></h6>
        </div>
      </div>
      <!-- Navbar -->
    	<ul class="navbar-nav float-right">
	        <li class="nav-item dropdown no-arrow">
	        	<a class="btn btn-light dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          ...
          <?php } ?>
					<a class="dropdown-item text-danger" href="do_files/do_logout.php"><i class="fa fa-power-off"></i> Logout</a>
				</div>
	        </li>
    	</ul>
