			...
			<div class="row bg-light border m-0 p-2">
				...
				<div class="col-md-4">
					<div class="input-group input-group-sm d-print-none">
						...
						<input type="date" id="delivery_time" onchange="ingredients()" class="form-control filter">
					</div>
				</div>
				<div class="col-md-2">
					<button onclick="window.print()" class="d-print-none float-right btn btn-sm btn-success"><i class="fa fa-print"></i></button>
